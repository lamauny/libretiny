...
PinInfo lt_arduino_pin_info_list[PINS_COUNT] = {
	...
	// D2: P2, ADC4, SCK
	{GPIO2,  PIN_I2S | PIN_ADC | PIN_IRQ | PIN_GPIO,            PIN_NONE, 0},
	// D3: P3, ADC5, WS
	{GPIO3,  PIN_I2S | PIN_ADC | PIN_IRQ | PIN_GPIO,            PIN_NONE, 0},
	// D4: P4, ADC1, DIN
	{GPIO4,  PIN_I2S | PIN_ADC | PIN_IRQ | PIN_GPIO,            PIN_NONE, 0},
	// D5: P5, ADC2, DOUT
	{GPIO5,  PIN_I2S | PIN_ADC | PIN_IRQ | PIN_GPIO,            PIN_NONE, 0},
	// D6: P6, PWM0
	...
	{GPIO12, PIN_UART | PIN_ADC | PIN_IRQ | PIN_GPIO,           PIN_NONE, 0},
	// D11: P13, ADC7, UART1_RTS
	{GPIO13, PIN_UART | PIN_ADC | PIN_IRQ | PIN_GPIO,           PIN_NONE, 0},
	// D12: P14, SD_CLK, SCK
	{GPIO14, PIN_SPI | PIN_IRQ | PIN_GPIO,                      PIN_NONE, 0},
	// D13: P15, SD_CMD, CS
	{GPIO15, PIN_SPI | PIN_IRQ | PIN_GPIO,                      PIN_NONE, 0},
	// D14: P16, SD_D0, MOSI
	{GPIO16, PIN_SPI | PIN_IRQ | PIN_GPIO,                      PIN_NONE, 0},
	// D15: P17, SD_D1, MISO
	{GPIO17, PIN_SPI | PIN_IRQ | PIN_GPIO,                      PIN_NONE, 0},
	// D16: P18, SD_D2
	{GPIO18, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
	// D17: P19, SD_D3
	{GPIO19, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
	...
	// D23: P25, DP
	{GPIO25, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
	// D24: P26, PWM5, IRDA
	{GPIO26, PIN_PWM | PIN_IRQ | PIN_GPIO,                      PIN_NONE, 0},
	// D25: P27, DVP_MCLK
	{GPIO27, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
	// D26: P28, DN
	{GPIO28, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
	// D27: P29, DVP_PCLK
	{GPIO29, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
	// D28: P30, DVP_HSYNC
	{GPIO30, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
	// D29: P31, DVP_VSYNC
	{GPIO31, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
	// D30: P32, DVP_PD0
	{GPIO32, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
	// D31: P33, DVP_PD1
	{GPIO33, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
	// D32: P34, DVP_PD2
	{GPIO34, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
	// D33: P35, DVP_PD3
	{GPIO35, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
	// D34: P36, DVP_PD4
	{GPIO36, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
	// D35: P37, DVP_PD5
	{GPIO37, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
	// D36: P38, DVP_PD6
	{GPIO38, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
	// D37: P39, DVP_PD7
	{GPIO39, PIN_IRQ | PIN_GPIO,                                PIN_NONE, 0},
};
