...
PinInfo lt_arduino_pin_info_list[PINS_COUNT] = {
	...
	// D6: P18, SD_D2, PWM4
	{GPIO18, PIN_PWM | PIN_IRQ | PIN_GPIO,            PIN_NONE, 0},
	// D7: P19, SD_D3, PWM5
	{GPIO19, PIN_PWM | PIN_IRQ | PIN_GPIO,            PIN_NONE, 0},
	// D8: P20, I2C1_SCL, TCK, FSCK
	{GPIO20, PIN_JTAG | PIN_I2C | PIN_IRQ | PIN_GPIO, PIN_NONE, 0},
	// D9: P4, ADC1, DIN
	{GPIO4,  PIN_I2S | PIN_IRQ | PIN_GPIO,            PIN_NONE, 0},
	// D10: P0, UART2_TX, I2C2_SCL
	{GPIO0,  PIN_UART | PIN_I2C | PIN_IRQ | PIN_GPIO, PIN_NONE, 0},
	// D11: P21, I2C1_SDA, TMS, ^FCS
	{GPIO21, PIN_JTAG | PIN_I2C | PIN_IRQ | PIN_GPIO, PIN_NONE, 0},
	// D12: P22, TDI, FSI
